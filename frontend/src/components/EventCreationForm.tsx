    ...
    <div className="flex flex-col lg:flex-row gap-12 p-8">
      <div className="lg:w-1/2">
        <div className="relative w-full h-[400px] overflow-hidden rounded-lg mt-[8px]">
              <img
                src="/img/landingimg.jpg?height=400&width=600"
                alt="Event cover"
                className="absolute inset-0 w-full h-full object-cover"
              />
              <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
                <Button variant="outline" className="text-black border-white hover:bg-white hover:scale-105 transition-colors">
      ...
      <div className="lg:w-1/2 bg-transparent">
        <Card className="shadow-none border-none bg-transparent">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2 sm:space-y-4">
              ...
              <div className="grid grid-cols-2 gap-2">
                <Input type="date" defaultValue="2024-10-19" className="bg-muted" />
          ...
          <div className="flex items-center gap-2 bg-muted/50 p-2 rounded-md w-fit">
            ...
            <span className="text-xs sm:text-sm text-muted-foreground">Singapore</span>
          </div>
            <div className="space-y-1.5">
              <Label htmlFor="location" className="text-sm font-medium">Event Location</Label>
              <Input id="location" placeholder="Enter event location" className="border-gray-300" />
            </div>
            <div className="space-y-1.5">
              <Label htmlFor="description" className="text-sm font-medium">Event Description</Label>
              <Textarea id="description" placeholder="Describe your event" className="border-gray-300" />
            </div>
            <div className="space-y-1.5">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <span className="text-xs sm:text-sm text-muted-foreground">Unlimited</span>
              </div>
            </div>
          </CardContent>
