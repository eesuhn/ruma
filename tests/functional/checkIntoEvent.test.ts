...
import { changeAttendeeStatus, checkIntoEvent, createBadge, createEvent, createProfile, generateAvatarUri, getAttendeePdaAndBump, getEventPdaAndBump, getFundedKeypair, getUserPdaAndBump, registerForEvent, umi } from "../utils";
...
describe("checkIntoEvent", () => {
  test("checking into event", async () => {
    ...
    const [edition] = findMasterEditionPda(umi, { mint: fromWeb3JsPublicKey(editionMint.publicKey) });
