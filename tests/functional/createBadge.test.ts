...
import { createBadge, createEvent, createProfile, generateAvatarUri, getEventPdaAndBump, getFundedKeypair, getUserPdaAndBump } from "../utils";
...
describe("createBadge", () => {
  test("creates a badge with max supply", async () => {
    ...
    const { metadataAcc, masterEditionAcc, eventAcc, masterTokenAcc } = await createBadge(
      organizer,
      masterMint,
      eventPda,
      badgeName,
