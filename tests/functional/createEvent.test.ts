...
import { createEvent, createProfile, generateAvatarUri, getEventDataPdaAndBump, getEventPdaAndBump, getFundedKeypair, getUserPdaAndBump } from "../utils";
...
describe("createEvent", () => {
  test("creates an event", async () => {
    ...
    const [eventPda, eventBump] = getEventPdaAndBump(organizerUserPda, eventName);
