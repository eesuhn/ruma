...
import { createBadge, createEvent, createProfile, generateAvatarUri, getAttendeePdaAndBump, getEventPdaAndBump, getFundedKeypair, getUserPdaAndBump, registerForEvent } from "../utils";
...
describe("registerForEvent", () => {
  test("registers for an event", async () => {
    ...
    const [attendeePda, attendeeBump] = getAttendeePdaAndBump(registrantUserPda, eventPda);
