...
export type Ruma = {
  ...
  instructions: [
    {
      ...
      discriminator: [124, 192, 107, 195, 207, 243, 25, 170];
      accounts: [
        {
          name: 'payer';
          writable: true;
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: 'const';
                value: [97, 116, 116, 101, 110, 100, 101, 101];
              },
              {
                kind: 'account';
                path: 'user';
    ...
    {
      name: 'checkIntoEvent';
      discriminator: [174, 115, 38, 67, 105, 235, 193, 133];
      accounts: [
        {
          name: 'payer';
          writable: true;
    ...
    {
      name: 'createBadge';
      discriminator: [25, 191, 79, 235, 98, 119, 184, 59];
      accounts: [
        {
          name: 'payer';
          writable: true;
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: 'const';
                value: [101, 118, 101, 110, 116, 95, 100, 97, 116, 97];
              },
              {
                kind: 'account';
                path: 'event';
    ...
    },
    {
      ...
      discriminator: [9, 43, 142, 151, 8, 125, 154, 139];
      accounts: [
        {
          name: 'payer';
          writable: true;
  ...
  accounts: [
    {
      name: 'attendee';
      discriminator: [231, 172, 150, 240, 220, 165, 51, 65];
    },
    {
      name: 'event';
    ...
    {
      name: 'eventData';
      discriminator: [245, 224, 183, 136, 42, 117, 154, 170];
    },
    {
      name: 'user';
